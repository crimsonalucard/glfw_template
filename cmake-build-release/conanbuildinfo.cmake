...
###  GLEW
#################
set(CONAN_GLEW_ROOT "/Users/brianyeh/.conan/data/glew/2.1.0/bincrafters/stable/package/8e2e3059f283d3d138b85d022534c5632c4ffd1b")
set(CONAN_INCLUDE_DIRS_GLEW "/Users/brianyeh/.conan/data/glew/2.1.0/bincrafters/stable/package/8e2e3059f283d3d138b85d022534c5632c4ffd1b/include")
set(CONAN_LIB_DIRS_GLEW "/Users/brianyeh/.conan/data/glew/2.1.0/bincrafters/stable/package/8e2e3059f283d3d138b85d022534c5632c4ffd1b/lib")
set(CONAN_BIN_DIRS_GLEW )
set(CONAN_RES_DIRS_GLEW )
set(CONAN_SRC_DIRS_GLEW )
set(CONAN_BUILD_DIRS_GLEW "/Users/brianyeh/.conan/data/glew/2.1.0/bincrafters/stable/package/8e2e3059f283d3d138b85d022534c5632c4ffd1b/")
...
###  GLFW
#################
set(CONAN_GLFW_ROOT "/Users/brianyeh/.conan/data/glfw/3.3/bincrafters/stable/package/f74366f76f700cc6e991285892ad7a23c30e6d47")
set(CONAN_INCLUDE_DIRS_GLFW "/Users/brianyeh/.conan/data/glfw/3.3/bincrafters/stable/package/f74366f76f700cc6e991285892ad7a23c30e6d47/include")
set(CONAN_LIB_DIRS_GLFW "/Users/brianyeh/.conan/data/glfw/3.3/bincrafters/stable/package/f74366f76f700cc6e991285892ad7a23c30e6d47/lib")
set(CONAN_BIN_DIRS_GLFW )
set(CONAN_RES_DIRS_GLFW )
set(CONAN_SRC_DIRS_GLFW )
set(CONAN_BUILD_DIRS_GLFW "/Users/brianyeh/.conan/data/glfw/3.3/bincrafters/stable/package/f74366f76f700cc6e991285892ad7a23c30e6d47/")
...
set(CONAN_EXE_LINKER_FLAGS_GLFW_LIST "-framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo")
...
set(CONAN_INCLUDE_DIRS "/Users/brianyeh/.conan/data/glew/2.1.0/bincrafters/stable/package/8e2e3059f283d3d138b85d022534c5632c4ffd1b/include"
			"/Users/brianyeh/.conan/data/glfw/3.3/bincrafters/stable/package/f74366f76f700cc6e991285892ad7a23c30e6d47/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/Users/brianyeh/.conan/data/glew/2.1.0/bincrafters/stable/package/8e2e3059f283d3d138b85d022534c5632c4ffd1b/lib"
			"/Users/brianyeh/.conan/data/glfw/3.3/bincrafters/stable/package/f74366f76f700cc6e991285892ad7a23c30e6d47/lib" ${CONAN_LIB_DIRS})
...
set(CONAN_FRAMEWORKS OpenGL ${CONAN_FRAMEWORKS})
set(CONAN_FRAMEWORKS_FOUND "")  # Will be filled later
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_BUILD_MODULES_PATHS  ${CONAN_BUILD_MODULES_PATHS})
set(CONAN_CMAKE_MODULE_PATH "/Users/brianyeh/.conan/data/glew/2.1.0/bincrafters/stable/package/8e2e3059f283d3d138b85d022534c5632c4ffd1b/"
			"/Users/brianyeh/.conan/data/glfw/3.3/bincrafters/stable/package/f74366f76f700cc6e991285892ad7a23c30e6d47/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_GLFW_DEPENDENCIES "${CONAN_SYSTEM_LIBS_GLFW} ${CONAN_FRAMEWORKS_FOUND_GLFW} ")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_GLFW}" "${CONAN_LIB_DIRS_GLFW}"
                                  ...
                                  "" glfw)
    set(_CONAN_PKG_LIBS_GLFW_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_GLFW_DEBUG} ${CONAN_FRAMEWORKS_FOUND_GLFW_DEBUG} ")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_GLFW_DEBUG}" "${CONAN_LIB_DIRS_GLFW_DEBUG}"
                                  ...
                                  "debug" glfw)
    set(_CONAN_PKG_LIBS_GLFW_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_GLFW_RELEASE} ${CONAN_FRAMEWORKS_FOUND_GLFW_RELEASE} ")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_GLFW_RELEASE}" "${CONAN_LIB_DIRS_GLFW_RELEASE}"
                                  ...
                                  "release" glfw)
    set(_CONAN_PKG_LIBS_GLFW_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_GLFW_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_GLFW_RELWITHDEBINFO} ")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_GLFW_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_GLFW_RELWITHDEBINFO}"
                                  ...
                                  "relwithdebinfo" glfw)
    set(_CONAN_PKG_LIBS_GLFW_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_GLFW_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_GLFW_MINSIZEREL} ")
    ...
    set(CONAN_TARGETS CONAN_PKG::glew CONAN_PKG::glfw)
